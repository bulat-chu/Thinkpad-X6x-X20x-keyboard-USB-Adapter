...
/* Modded file for ThinkPad wakeup event.
Changes: disabled keyboard matrix scanning and added scanning only suspend_wakeup_condition_user buttons in keymap.c file
*/
...
bool suspend_wakeup_condition(void) {
    extern bool suspend_wakeup_condition_user(void);
